...
{{--                        <li><a href="{{route('front.index')}}#réservation" style="font-size: 12px;">Réservation</a></li>--}}
                        ...
                        @if($user->role==3)
                            ...
                            <li><a href="{{route('acount.request')}}" >Acount Request</a></li>
                        @endif

                        <li><a href="{{route('notfications.index')}}" >Notfications</a></li>
                        @auth
    ...
    $(document).on("click", "#send-it", function() {
        ...
        if ("" != a.value) {
            ...
            if (
                ...
                var d = "whatsapp://send";
            var g = d + "?phone=+639183283871" + e + f;
